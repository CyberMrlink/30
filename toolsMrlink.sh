clear
echo "\033[34;1m Selamat Datang di Tool Mr.LINKERRORSYSTEM"
sleep 1
echo "\033[35;1m Anda disini dapat menginstall berbagai tools" | lolcat
sleep 1
echo "tool ini sekarang sudah versi 2.0 dan bukan beta lagi" | lolcat
...
read -p "#Mr.LINKERRORSYSTEM ~>#" pilihan
